...
<template>
    <form @submit.prevent="handleSignIn(data)" class="form_container">
        ...
        <div class="title_container">
            <p class="title">Login to Hive</p>
            <span class="subtitle">Hive allows people to connect with each other online and share moments.</span>
        </div>
        <div class="input_container">
            ...
            <input v-model="data.email" required placeholder="name@mail.com" name="input-name" type="email"
        ...
        <div class="input_container">
            ...
            <input v-model="data.password" required placeholder="Password" name="input-name" type="password"
                class="input_field" id="password_field">
        </div>
        <button type="submit" class="btn-main sign-in">
            <span>Sign In</span>
        </button>
        ...
        <button type="button" class="btn-main sign-in_ggl">
            <IconAuthGoogle />
            <span>Sign In with Google</span>
        </button>
        <button type="button" class="btn-main sign-in_fb">
            <IconAuthFacebook />
            <span>Sign In with Facebook</span>
        </button>
        <a href="#" class="note">Terms of use &amp; Conditions</a>
    </form>
</template>
...
.sign-in_ggl:hover {
    color: #fff;
    background: linear-gradient(to left, #FF0000, rgba(255, 44, 44, 0.25)), #FF7878;
}
...
.sign-in_fb:hover {
    color: #fff;
    background: linear-gradient(to left, #009FFD, rgba(44, 118, 255, 0.25)), #2A2A72;
}
